...
export const AgentSelector: React.FC<AgentSelectorProps> = ({
  ...
  const getAgentDisplay = () => {
    ...
    if (selectedAgentId !== undefined) {
      console.warn('Agent with ID', selectedAgentId, 'not found, falling back to Operabase');
    }
    
    // Default to Operabase (the first agent which has id: undefined)
  ...
  const handleAgentSelect = (agentId: string | undefined) => {
    console.log('Agent selected:', agentId === undefined ? 'Operabase (default)' : agentId);
